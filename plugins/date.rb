...
module Octopress
  module Date
    ...
    COMMOM_DAYNAMES_RU = ["недеља", "понедељак", "уторак", "среда", "четвртак", "петак", "субота"]
    DAYNAMES_RU = ["Недеља", "Понедељак", "Уторак", "Среда", "Четвртак", "Петак", "Субота"]
    ABBR_DAYNAMES_RU = ["Недеља", "Понедељак", "Уторак", "Среда", "Четвртак", "Петак", "Субота"]
    STANDALONE_ABBR_DAYNAMES_RU = ["нед", "пон", "уто", "сре", "чет", "пет", "суб"]
    ...
    COMMON_MONTHNAMES_RU = [nil, "јануар", "фебруар", "март", "април", "мај", "јун", "јул", "август", "септембар", "октобар", "новембар", "децембар"]
    MONTHNAMES_RU = [nil, "Јануар", "Фебруар", "Март", "Април", "Мај", "Јун", "Јул", "Август", "Септембар", "Октобар", "Новембар", "Децембар"]
    COMMON_ABBR_MONTHNAMES_RU = [nil, "јан.", "феб.", "мар.", "апр.", "мај", "јун", "јул", "авг.", "сеп.", "окт.", "нов.", "дец."]
    ABBR_MONTHNAMES_RU = [nil, "Јан.", "Феб.", "Мар.", "Апр.", "Мај", "Јун", "Јул", "Авг.", "Сеп.", "Окт.", "Нов.", "Дец."]
